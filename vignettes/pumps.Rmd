...
pumps_nodes <- readr::read_csv(
  system.file("extdata/examples/pumps/nodes.csv", package = pkg),
  show_col_types = FALSE
)
pumps_edges <- readr::read_csv(
  system.file("extdata/examples/pumps/edges.csv", package = pkg),
  show_col_types = FALSE
)
