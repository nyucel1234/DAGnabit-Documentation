...
We export a PNG and store it under inst/extdata/examples/salm/salm_layout.png. Once exported, that PNG can be included in other documentation or compared visually to the WinBUGS reference.
